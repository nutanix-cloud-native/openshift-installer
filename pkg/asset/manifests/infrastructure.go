	...
	case nutanix.Name:
		...
		config.Spec.PlatformSpec.Nutanix = &configv1.NutanixPlatformSpec{
			...
			PrismElements: []configv1.NutanixPrismElementEndpoint{{
				Name: installConfig.Config.Nutanix.PrismElements[0].Endpoint.Name,
				Endpoint: configv1.NutanixPrismEndpoint{
					Address: installConfig.Config.Nutanix.PrismElements[0].Endpoint.Endpoint.Address,
					Port:    installConfig.Config.Nutanix.PrismElements[0].Endpoint.Endpoint.Port,
				},
			}},
		}
